...
{
  @Override
  public List<SingleMeasurement> getHumidityForUser(String userId)
  {
    List<SingleMeasurement> measurements = new ArrayList<>();

    String QUERY = "SELECT id, m.eui, timestamp, humidity "
    ...
    {
      System.out.println("SQL exception for get humidity for userId: "
          + e.getMessage());
    }
  ...
  @Override
  public List<SingleMeasurement> getHumidityForEui(String eui)
  {
    List<SingleMeasurement> measurements = new ArrayList<>();

    String QUERY = "SELECT id, eui, timestamp, humidity "
    ...
    {
      System.out.println("SQL exception for get humidity for eui: "
          + e.getMessage());
    }
