...
import org.terraeyes.terraeyesdb.dataAccess.carbon.CarbonDioxideDao;
...
public class CarbonDioxideControllerImpl implements CarbonDioxideController
{
  ...
  @Override
  public List<SingleMeasurement> getCarbonDioxidesForUser(@PathVariable String userId)
  {
  ...
  @Override
  public List<SingleMeasurement> getCarbonDioxidesForEui(@PathVariable String eui)
  {
